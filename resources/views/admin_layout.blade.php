...
<body>
		...
		<div class="navbar-inner">
			<div class="container-fluid">
				...
				<a class="brand" href="index.html"><span>Humayun</span></a>
			...
			<div id="sidebar-left" class="span2">
				<div class="nav-collapse sidebar-nav">
					<ul class="nav nav-tabs nav-stacked main-menu">
						...
						<li><a href="{{ url('/add-category') }}"><i class="icon-tasks"></i><span class="hidden-tablet"> Add Category</span></a></li>

						<li><a href="{{ url('/all/manufacture') }}"><i class="icon-eye-open"></i><span class="hidden-tablet"> All Brand</span></a></li>

						<li><a href="{{ url('/add/manufacture') }}"><i class="icon-dashboard"></i><span class="hidden-tablet"> Add Brand</span></a></li>
						<li>
							...
							<ul>
								<li>
									<a class="submenu" href="{{ url('/add/product') }}">
								...
								<li>
									<a class="submenu" href="{{ url('/all/product') }}">
										<i class="icon-file-alt"></i>
										<span class="hidden-tablet">
										 All Product
										</span></a>
						...
						<li><a href="{{ url('/add/slider') }}"><i class="icon-edit"></i><span class="hidden-tablet">Add Slider</span></a></li>

						<li><a href="{{ url('/all/slider') }}"><i class="icon-edit"></i><span class="hidden-tablet">All Slider</span></a></li>
						...
						<li><a href="gallery.html"><i class="icon-picture"></i><span class="hidden-tablet"> Delivaery Man</span></a></li>
