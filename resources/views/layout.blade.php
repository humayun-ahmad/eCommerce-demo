                ...
                <div class="col-sm-12">
                    <div id="slider-carousel" class="carousel slide" data-ride="carousel">
                        ...
                        <div class="carousel-inner">
                            <?php 
                            $all_slider = DB::table('tbl_slider')->where('publication_status', 1)->get();
                            $active = 1;
                ...
                <div class="col-sm-3">
                    <div class="left-sidebar">
                        ...
                        <div class="brands_products"><!--brands_products-->
                            ...
                            $all_manufacture_list = DB::table('tbl_manufacture')->where('publication_status', 1)->get();

                            foreach($all_manufacture_list as $manufacture){
                             ?>

                                    <li><a href="{{ url('/product-by-manufacture/'.$manufacture->manufacture_id) }}"> <span class="pull-right">(50)</span>{{ $manufacture->manufacture_name }}</a></li>
